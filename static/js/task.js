...
var database = new Firebase('https://memtronome2.firebaseio.com');
...
var Experiment = function() {
	...
	var ISIlevels = ISI_LEVELS //_.shuffle(ISI_LEVELS);
	...
	ISItype = 'rhythmic';
	condition_name = "rhythmicISI"; // maybe randomize if increasing or decreasing by block
